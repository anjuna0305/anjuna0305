# Hi, I'm Kavishka Anjuna 👋

Full stack developer & DevOps engineer from Colombo, Sri Lanka 🇱🇰  
Currently building language technology tools at the **Language Technology Research Laboratory, UCSC**.
...
|---|---|---|
| [Subasa](https://subasa.lk) | Multi-service AI platform — Sinhala TTS voicebot, ASR, RAG chatbots | FastAPI, Next.js, Go, Docker |
| [mocc.dev](https://mocc.dev) | Mock server builder from API docs using LLMs | Python, React, TypeScript |
| Granton CRM | CRM system for Granton Group | CI/CD, PM2, Nginx |
| CranCo | Social networking platform for vehicle enthusiasts | Spring Boot, React, Neo4j |
| READ | Inventory & user management desktop app | Electron, TypeScript, SQLite |
...
![Profile trophies](https://github-profile-trophy.vercel.app/?username=anjunaSk&no-frame=true&column=6&margin-w=4)

---

*CS undergrad @ University of Colombo School of Computing*
